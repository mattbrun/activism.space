 ...
 */
 ...
 if (function_exists('childtheme_override_mk_slider_template'))  {
	...
	$out .='</div> <a href="'.esc_url(get_theme_mod('mk_slide3_url', '#')).'" class="btn btn-lg '.get_theme_mod('mk_slider_button','btn-success').'">'.esc_attr(get_theme_mod('mk_slide3_btntext', 'Learn more')).'</a>'."\n";
	$out .='</article>'."\n";
	$out .='</li>'."\n";
	endif;
	 $out .='</ul>'."\n";
